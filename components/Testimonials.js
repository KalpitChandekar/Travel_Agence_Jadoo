  ...
  return (
    <div className="flex max-w-6xl mx-auto mt-40 mb-60 justify-around">
      ...
      <div className="flex items-center relative">
        <div className="shadow-xl bg-white p-4 rounded-3xl flex">
          <div>
            <Image
              src="/testimonial.png"
              width={76}
        ...
        <div className="absolute -bottom-16 left-14 -z-10 shadow-xl p-4 rounded-3xl flex bg-[#F7F7F7]">
          <div>
            <Image
              src="/testimonial.png"
              width={76}
          ...
          <div className="space-y-6 pt-16">
            ...
            <div className="space-y-1">
              <h1 className="text-gray">Chris Thomas</h1>
              <p className="text-gray text-sm">CEO of Red Button</p>
            </div>
          </div>
        </div>
      </div>
